          ...
          <div className=" w-[50%] pl-6 pr-4 text-gray-300">
            ...
            <div>
              ...
              <div className=" p-6 bg-[#343A40] rounded-lg">
                  <h2 className=" text-lg font-bold text-white mb-3" >Withdraw Raised Funds</h2>

                  <div className=" p-4 rounded-md bg-blue-200 flex items-center gap-3 mb-3">
                    <BiInfoCircle className=" text-blue-800" size={20}/>
                    <span className=" text-base text-blue-800">To withdraw raised funds, campaign has to be <span className=" font-bold">ended</span></span>
                  </div>
                  ...
                  <div className=" p-4 rounded-md bg-orange-200 flex items-center gap-3 mb-6">
                    ...
                    <span className=" text-base text-orange-800">I/We undestand that, once campaign has ended it cannot be reversed.</span>
                  </div>
