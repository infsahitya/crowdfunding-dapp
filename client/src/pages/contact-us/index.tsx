      ...
      <form className="space-y-6 text-gray-300">
        <div>
          ...
          <input
            ...
            type="text"
            placeholder=""
            className="w-full p-3 rounded bg-background border-gray-300 outline-none border"
          />
        </div>
        <div>
        ...
        <button
          type="submit"
          className="w-full p-3 text-sm font-bold tracking-wide uppercase rounded bg-primary text-black"
        >
          Send Message
        </button>
      </form>
