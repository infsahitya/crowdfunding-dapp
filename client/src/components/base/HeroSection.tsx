      ...
      <div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row ">
        <div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
          <h1 className="text-5xl font-bold leading-none sm:text-6xl">
            Together <span className=" text-primary">We</span> Can Make a{" "}
            <span className=" text-primary">Difference</span>
          </h1>
          <p className="mt-6 mb-8 text-lg sm:mb-12">
            Fund the Future of Hope and Opportunity. Support <br /> NGOs, NPOs,
            and STCs through Decentralized Fundraising
          </p>
        ...
        <div className="flex items-center justify-center py-0 mt-8 lg:mt-0 h-72 sm:h-80 lg:h-[30rem] xl:h-112 2xl:h-128">
          <img
            src={Bg}
            alt=""
            className="object-contain h-72 sm:h-80 lg:h-[30rem] xl:h-112 2xl:h-128"
          />
        </div>
      </div>
    </section>
